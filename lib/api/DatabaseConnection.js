...
module.exports = class DatabaseConnection {
  ...
  async setServerAttributes(attributes) {
    ...
    const length = this.readReplyHeader("setServerAttributes");
      ...
      if (rcClassReturnCode >= 0) {
        ...
        while (numRead < length) {
          ...
          switch (cp) {
            ...
            default:
              connection.skipBytes(ll-6); //TODO: correct inner code
              break;
          }
          numRead += ll;
        }
  ...
  static parseSQLCA(buffer) {
    ...
    const generatedKey = ''; //TODO: Conv.packedDecimalToString(byteBuffer_, 72, 30, 0, charBuffer_);
