...
const {DatabaseServerAttributes, ServerAttributeIDs} = require("./DatabaseServerAttributes");
const {DatabaseRequestAttributes, RequestAttributeIDs} = require('./DatabaseRequestAttributes');
const DataBuffer = require("./DataBuffer");
const SQLCommunicationsArea = require("./SQLCommunicationsArea");
const OperationalResultBitmap = require('./OperationalResultBitmap');
const { REPLY_RLE_COMPRESSED } = require("./OperationalResultBitmap");
