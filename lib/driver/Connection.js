...
module.exports = class Connection {
  ...
  constructor(connection) {
    ...
    this.requestParameterBlocks = Array.from(32767).fill(false);
  ...
  getNextCursorName() {
    if (this.cursors.free.length > 0) {
      ...
      var cursorName = 'CRSR000000'.split('');
  ...
  getNextRPBID() {
    ...
    const id = this.requestParameterBlocks.findIndex(x = x === true);
  ...
  createStatement() {
    ...
    return new Statement(this, statementName, cursorName, rpbID);
  }
}